...
Source2  : https://www.clamav.net/downloads/production/clamav-0.103.2.tar.gz.sig
...
%prep
%setup -q -n clamav-0.103.2
cd %{_builddir}/clamav-0.103.2
%patch1 -p1
pushd ..
cp -a clamav-0.103.2 buildavx2
popd
...
cp %{_builddir}/clamav-0.103.2/COPYING.LGPL %{buildroot}/usr/share/package-licenses/clamav/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/clamav-0.103.2/COPYING.YARA %{buildroot}/usr/share/package-licenses/clamav/c9b166c9c918ac6f123f0c70778297eb118537bc
cp %{_builddir}/clamav-0.103.2/COPYING.bzip2 %{buildroot}/usr/share/package-licenses/clamav/521256a2cd47b39b31811a5df9bb724662ae326e
cp %{_builddir}/clamav-0.103.2/COPYING.file %{buildroot}/usr/share/package-licenses/clamav/6178fe3d7980af9da8d734c13c56599b6775a20b
cp %{_builddir}/clamav-0.103.2/COPYING.getopt %{buildroot}/usr/share/package-licenses/clamav/a4b006d9829d39c162d3853cf45ef8aa2844615c
cp %{_builddir}/clamav-0.103.2/COPYING.llvm %{buildroot}/usr/share/package-licenses/clamav/4bdc478d273e3e8c75dbafbce0dc50bb8abc3628
cp %{_builddir}/clamav-0.103.2/COPYING.pcre %{buildroot}/usr/share/package-licenses/clamav/24c848a024de84cdf4f7db7e65d5102b329a43bd
cp %{_builddir}/clamav-0.103.2/COPYING.regex %{buildroot}/usr/share/package-licenses/clamav/28f373b92a4e7883d7243dfc65bb6fc0c9ca167e
cp %{_builddir}/clamav-0.103.2/COPYING.zlib %{buildroot}/usr/share/package-licenses/clamav/0e1e05a11f29e9060b21c3926ddf6e80d441ca37
cp %{_builddir}/clamav-0.103.2/libclamav/c++/llvm/LICENSE.TXT %{buildroot}/usr/share/package-licenses/clamav/22b913e80d34b4b5eba70ee11d70f1f487d97348
cp %{_builddir}/clamav-0.103.2/libclamav/c++/llvm/autoconf/LICENSE.TXT %{buildroot}/usr/share/package-licenses/clamav/7aecc4590c57a3f3a0735a7e339d8635938d330f
cp %{_builddir}/clamav-0.103.2/libclammspack/COPYING.LIB %{buildroot}/usr/share/package-licenses/clamav/e60c2e780886f95df9c9ee36992b8edabec00bcc
cp %{_builddir}/clamav-0.103.2/libltdl/COPYING.LIB %{buildroot}/usr/share/package-licenses/clamav/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/clamav-0.103.2/unit_tests/input/COPYING %{buildroot}/usr/share/package-licenses/clamav/dfac199a7539a404407098a2541b9482279f690d
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
